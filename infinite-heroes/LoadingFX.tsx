...
const LOADING_FX = ["¡PUM!", "¡ZAS!", "¡KABOOM!", "¡CRACK!", "¡WOW!", "¡FIUU!", "¡PLOP!", "¡BOOM!"];
...
export const LoadingFX: React.FC = () => {
    ...
    return (
        <div className="w-full h-full bg-white overflow-hidden relative border-r-4 border-gray-300">
            ...
            <p className="absolute bottom-24 inset-x-0 text-center font-comic text-xl text-gray-400 animate-pulse z-0 tracking-widest">DIBUJANDO...</p>
        </div>
    );
};
